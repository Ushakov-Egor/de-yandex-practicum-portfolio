...
nickname = 'your_nickname'  # задать через переменную окружения
cohort = 'your_cohort'    # задать через переменную окружения
...
def upload_data_to_staging(filename, date, pg_table, pg_schema, ti):
    ...
    print(f'Столбцы в df: {df.columns}')
...
with DAG(
    ...
    update_f_customer_retention = PostgresOperator(
        ...
        postgres_conn_id=postgres_conn_id,
        sql="sql/infill_mart.f_customer_retention.sql"
    )
